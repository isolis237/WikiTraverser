...
# 	g++ -std=c++17 adjacency_list.o digraph.o directed_edge.o node.o dfs.o dijkstra.o main.o -o wikiTraverser
# 	@echo "\n****************************************************************************************************\n"
...
# 	g++ -std=c++17 -c ./main/src/adjacency_list.cpp

# digraph.o: main/src/digraph.cpp
# 	g++ -std=c++17 -c ./main/src/digraph.cpp

# directed_edge.o: main/src/directed_edge.cpp
# 	g++ -std=c++17 -c ./main/src/directed_edge.cpp

# node.o: main/src/node.cpp
# 	g++ -std=c++17 -c ./main/src/node.cpp

# dfs.o: main/src/dfs.cpp
# 	g++ -std=c++17 -c ./main/src/dfs.cpp

# dijkstra.o: main/src/dijkstra.cpp
# 	g++ -std=c++17 -c ./main/src/dijkstra.cpp
...
INCLUDES := -Imain/refactored_include

TARGET := wikiTraverser

SRC_DIR := main/refactored_src
...
# Generic compile rule for any .cpp -> .o
%.o: %.cpp
...
# 	g++ -std=c++17 -c ./main/tests/test_adjacency_lists.cpp

# test_dfs.o: ./main/tests/test_dfs.cpp
# 	g++ -std=c++17 -c ./main/tests/test_dfs.cpp

# test_digraph.o: ./main/tests/test_digraph.cpp
# 	g++ -std=c++17 -c ./main/tests/test_digraph.cpp

# test_dijkstra.o: ./main/tests/test_dijkstra.cpp
# 	g++ -std=c++17 -c ./main/tests/test_dijkstra.cpp

# test_directed_edges.o: ./main/tests/test_directed_edges.cpp
# 	g++ -std=c++17 -c ./main/tests/test_directed_edges.cpp

# test_node.o: ./main/tests/test_node.cpp
# 	g++ -std=c++17 -c ./main/tests/test_node.cpp

# test.o: ./main/tests/test.cpp
# 	g++ -std=c++17 -c ./main/tests/test.cpp
